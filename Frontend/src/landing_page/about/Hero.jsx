...
function AboutHero() {
  return (
    <div className="container aboutContainer mt-5 mb-5">
      <div className="mt-5  text-center pt-5 aboutHeadingDiv">
        <h2 className="aboutHeroHeading">
          We pioneered the discount broking model in India. <br />
          Now, we are breaking ground with our technology.
        </h2>
      </div>
      <div className="row mb-5 mt-5 infoDiv">
