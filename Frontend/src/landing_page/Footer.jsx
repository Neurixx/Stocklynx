function Footer() {
  return (
    <div className="mt-5 pt-5 footerContainer">
      <div className="row mb-5">
        <div className="col">
          <img className="logoImg mb-3" src="assets/logo.svg" alt="Zerodha" />
          <p className="footerUpPara mb-0">
            © 2010 - 2025, Zerodha Broking Ltd.
          </p>
          <p className="footerUpPara">All rights reserved.</p>
        ...
        <div className="col">
          <ul className="footerUl ">
            <li className="list-head mb-3">Account</li>
            <li>
        ...
        <div className="col">
          <ul className="footerUl ">
            <li className="list-head mb-3">Support</li>
            <li>
              <a href="#">Contact us</a>
            </li>
            <li>
        ...
        <div className="col">
          <ul className="footerUl">
            <li className="list-head mb-3">Company</li>
            <li>
              <a href="#">About</a>
            </li>
            <li>
        ...
        <div className="col">
          <ul className="footerUl">
            <li className="list-head mb-3">Quick links</li>
            <li>
        ...
        <div className="extraFooterInfo mt-5">
          <p>
